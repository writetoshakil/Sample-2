<%@ Page Language="C#" MasterPageFile="~/mp.master" AutoEventWireup="true" CodeFile="frmFileType.aspx.cs" Inherits="frmFileType" Title="File Type Information" %>
            ...
            <table align="center" width="950">
                ...
                <tr>
                    ...
                    <td style="width: 326px; text-align: left">
                        <asp:TextBox ID="txtFileType" runat="server" CssClass="textBox" Width="326px"></asp:TextBox></td>
                    <td style="width: 237px; text-align: left">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFileType"
            ...
            <table align="center" width="950">
                <tr>
                    ...
                    <td style="width: 600px; text-align: left">
                        <asp:GridView ID="gvFileType" runat="server" AutoGenerateColumns="False">
                            <Columns>
